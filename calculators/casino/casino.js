...
// Add event listeners if needed, e.g., for real-time updates (though button clicks are fine here)
// document.getElementById('bj-bet').addEventListener('input', calculateBlackjackPayout);
// document.getElementById('bj-outcome').addEventListener('change', calculateBlackjackPayout);
// document.getElementById('rtb-bet').addEventListener('input', calculateRtbPayout);